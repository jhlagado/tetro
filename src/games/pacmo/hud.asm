; Pacmo-local seven-segment HUD helpers.
; These routines are close to generic, but stay local until Pacmo and TETRO
; agree on shared score labels and segment table names.
